...
Model Use
Intended use
These models are intended for low-latency, on-device English speech transcription on memory- and compute-constrained platforms (roughly 0.1--1TOPS and sub-1GB memory budgets). Typical applications include live captioning, voice commands, and real-time transcription.
